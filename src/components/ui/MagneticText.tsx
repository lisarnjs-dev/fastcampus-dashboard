...
export function MagneticText({ text = "CREATIVE", hoverText = "EXPLORE", className }: MagneticTextProps) {
  ...
  return (
    ...
    >
      ...
      <span className="text-5xl tracking-wide text-foreground" style={{ fontFamily: "var(--font-shadows-into-light)" }}>{text}</span>
      ...
      >
        ...
        >
          <span className="text-5xl tracking-wide text-background whitespace-nowrap" style={{ fontFamily: "var(--font-shadows-into-light)" }}>
            {hoverText}
          </span>
        </div>
      </div>
